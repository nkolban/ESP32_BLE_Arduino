...
void BLEDescriptorCallbacks::onRead(BLEDescriptor* pDescriptor) {
	ESP_LOGV("BLEDescriptorCallbacks", ">> onRead: default");
	ESP_LOGV("BLEDescriptorCallbacks", "<< onRead");
} // onRead
...
void BLEDescriptorCallbacks::onWrite(BLEDescriptor* pDescriptor) {
	ESP_LOGV("BLEDescriptorCallbacks", ">> onWrite: default");
	ESP_LOGV("BLEDescriptorCallbacks", "<< onWrite");
} // onWrite
